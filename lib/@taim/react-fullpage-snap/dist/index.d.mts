...
declare function FullPageProvider({ children, scrollingSpeed, anchors, menu, lockAnchors, onSectionChange, beforeScroll, afterScroll, keyboardScrolling, touchScrolling, wheelScrolling, scrollThreshold, touchThreshold, }: FullPageProviderProps): react_jsx_runtime.JSX.Element;

interface FullPageWrapperProps {
    children: React.ReactNode;
    className?: string;
}
declare function FullPageWrapper({ children, className }: FullPageWrapperProps): react_jsx_runtime.JSX.Element;
...
export { type FullPageContextValue, type FullPageOptions, FullPageProvider, FullPageWrapper, Section, type SectionInfo, useFullPage };
